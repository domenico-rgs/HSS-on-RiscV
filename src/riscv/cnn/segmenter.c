    ...
    for(int i=0; i<ENC_0_CONV_RELU_0_N; i++){    // Iterate over the input matrix
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_0_CONV_RELU_0_INPUT_FEATURES; j++){
          // Multiply the input by the weights and accumulate, each timy apply an approximation and scale the result to match the format
    ...
    for(int i=0; i<ENC_0_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_0_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_1[l*ENC_0_CONV_RELU_0_OUTPUT_FEATURES+j]*enc_0_conv_relu_1_w[(k*ENC_0_CONV_RELU_1_K+(l-i+ENC_0_CONV_RELU_1_K/2))*ENC_0_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<ENC_1_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_1_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_1[l*ENC_0_CONV_RELU_1_OUTPUT_FEATURES+j]*enc_1_conv_relu_0_w[(k*ENC_1_CONV_RELU_0_K+(l-i+ENC_1_CONV_RELU_0_K/2))*ENC_1_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<ENC_1_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_1_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_2[l*ENC_1_CONV_RELU_0_OUTPUT_FEATURES+j]*enc_1_conv_relu_1_w[(k*ENC_1_CONV_RELU_1_K+(l-i+ENC_1_CONV_RELU_1_K/2))*ENC_1_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<ENC_2_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_2_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_2[l*ENC_1_CONV_RELU_1_OUTPUT_FEATURES+j]*enc_2_conv_relu_0_w[(k*ENC_2_CONV_RELU_0_K+(l-i+ENC_2_CONV_RELU_0_K/2))*ENC_2_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<ENC_2_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_2_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_1[l*ENC_2_CONV_RELU_0_OUTPUT_FEATURES+j]*enc_2_conv_relu_1_w[(k*ENC_2_CONV_RELU_1_K+(l-i+ENC_2_CONV_RELU_1_K/2))*ENC_2_CONV_RELU_1_INPUT_FEATURES+j] + approx )>>FXP;
    ...
    for(int i=0; i<ENC_3_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_3_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_1[l*ENC_2_CONV_RELU_1_OUTPUT_FEATURES+j]*enc_3_conv_relu_0_w[(k*ENC_3_CONV_RELU_0_K+(l-i+ENC_3_CONV_RELU_0_K/2))*ENC_3_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<ENC_3_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_3_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_2[l*ENC_3_CONV_RELU_0_OUTPUT_FEATURES+j]*enc_3_conv_relu_1_w[(k*ENC_3_CONV_RELU_1_K+(l-i+ENC_3_CONV_RELU_1_K/2))*ENC_3_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
        }
      }
    ...
    for(int i=0; i<CENTRAL_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<CENTRAL_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_2[l*ENC_3_CONV_RELU_1_OUTPUT_FEATURES+j]*central_conv_relu_0_w[(k*CENTRAL_CONV_RELU_0_K+(l-i+CENTRAL_CONV_RELU_0_K/2))*CENTRAL_CONV_RELU_0_INPUT_FEATURES+j]  + approx)>>FXP;
    ...
    for(int i=0; i<CENTRAL_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<CENTRAL_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_1[l*CENTRAL_CONV_RELU_0_OUTPUT_FEATURES+j]*central_conv_relu_1_w[(k*CENTRAL_CONV_RELU_1_K+(l-i+CENTRAL_CONV_RELU_1_K/2))*CENTRAL_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
        }
      }
    ...
    for(int i=0; i<DEC_0_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += (array_1[l*DEC_0_UP_CONV_RELU_INPUT_FEATURES+j]*dec_0_up_conv_relu_w[(k*DEC_0_UP_CONV_RELU_K+(l-i+DEC_0_UP_CONV_RELU_K/2))*DEC_0_UP_CONV_RELU_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_0_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_1[l*(DEC_0_UP_CONV_RELU_OUTPUT_FEATURES*2)+j]*dec_0_conv_relu_0_w[(k*DEC_0_CONV_RELU_0_K+(l-i+DEC_0_CONV_RELU_0_K/2))*DEC_0_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP; 
    ...
    for(int i=0; i<DEC_0_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_2[l*DEC_0_CONV_RELU_0_OUTPUT_FEATURES+j]*dec_0_conv_relu_1_w[(k*DEC_0_CONV_RELU_1_K+(l-i+DEC_0_CONV_RELU_1_K/2))*DEC_0_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_1_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += (array_2[l*DEC_1_UP_CONV_RELU_INPUT_FEATURES+j]*dec_1_up_conv_relu_w[(k*DEC_1_UP_CONV_RELU_K+(l-i+DEC_1_UP_CONV_RELU_K/2))*DEC_1_UP_CONV_RELU_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_1_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_2[l*(DEC_1_UP_CONV_RELU_OUTPUT_FEATURES*2)+j]*dec_1_conv_relu_0_w[(k*DEC_1_CONV_RELU_0_K+(l-i+DEC_1_CONV_RELU_0_K/2))*DEC_1_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_1_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_1[l*DEC_1_CONV_RELU_0_OUTPUT_FEATURES+j]*dec_1_conv_relu_1_w[(k*DEC_1_CONV_RELU_1_K+(l-i+DEC_1_CONV_RELU_1_K/2))*DEC_1_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_2_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += (array_1[l*DEC_2_UP_CONV_RELU_INPUT_FEATURES+j]*dec_2_up_conv_relu_w[(k*DEC_2_UP_CONV_RELU_K+(l-i+DEC_2_UP_CONV_RELU_K/2))*DEC_2_UP_CONV_RELU_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_2_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_1[l*(DEC_2_UP_CONV_RELU_OUTPUT_FEATURES*2)+j]*dec_2_conv_relu_0_w[(k*DEC_2_CONV_RELU_0_K+(l-i+DEC_2_CONV_RELU_0_K/2))*DEC_2_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_2_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_2[l*DEC_2_CONV_RELU_0_OUTPUT_FEATURES+j]*dec_2_conv_relu_1_w[(k*DEC_2_CONV_RELU_1_K+(l-i+DEC_2_CONV_RELU_1_K/2))*DEC_2_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_3_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += (array_2[l*DEC_3_UP_CONV_RELU_INPUT_FEATURES+j]*dec_3_up_conv_relu_w[(k*DEC_3_UP_CONV_RELU_K+(l-i+DEC_3_UP_CONV_RELU_K/2))*DEC_3_UP_CONV_RELU_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_3_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += (array_2[l*(DEC_3_UP_CONV_RELU_OUTPUT_FEATURES*2)+j]*dec_3_conv_relu_0_w[(k*DEC_3_CONV_RELU_0_K+(l-i+DEC_3_CONV_RELU_0_K/2))*DEC_3_CONV_RELU_0_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<DEC_3_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += (array_1[l*DEC_3_CONV_RELU_0_OUTPUT_FEATURES+j]*dec_3_conv_relu_1_w[(k*DEC_3_CONV_RELU_1_K+(l-i+DEC_3_CONV_RELU_1_K/2))*DEC_3_CONV_RELU_1_INPUT_FEATURES+j] + approx)>>FXP;
    ...
    for(int i=0; i<FINAL_CONV_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<FINAL_CONV_INPUT_FEATURES; j++){
          acc += (array_2[l*DEC_3_CONV_RELU_1_OUTPUT_FEATURES+j]*final_conv_w[(k*FINAL_CONV_K+(l-i+FINAL_CONV_K/2))*FINAL_CONV_INPUT_FEATURES+j] + approx)>>FXP;
