...
void Segmenter(datatype x[N*N_FEATURES],
    ...
    for(int i=0; i<ENC_0_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_0_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += enc_0_conv_relu_0[l][j]*enc_0_conv_relu_1_w[k*ENC_0_CONV_RELU_1_K*ENC_0_CONV_RELU_1_INPUT_FEATURES+(l-i+ENC_0_CONV_RELU_1_K/2)*ENC_0_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      enc_0_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_1_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_1_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += enc_0_maxpool[l][j]*enc_1_conv_relu_0_w[k*ENC_1_CONV_RELU_0_K*ENC_1_CONV_RELU_0_INPUT_FEATURES+(l-i+ENC_1_CONV_RELU_0_K/2)*ENC_1_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      enc_1_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_1_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_1_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += enc_1_conv_relu_0[l][j]*enc_1_conv_relu_1_w[k*ENC_1_CONV_RELU_1_K*ENC_1_CONV_RELU_1_INPUT_FEATURES+(l-i+ENC_1_CONV_RELU_1_K/2)*ENC_1_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      enc_1_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_2_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_2_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += enc_1_maxpool[l][j]*enc_2_conv_relu_0_w[k*ENC_2_CONV_RELU_0_K*ENC_2_CONV_RELU_0_INPUT_FEATURES+(l-i+ENC_2_CONV_RELU_0_K/2)*ENC_2_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      enc_2_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_2_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_2_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += enc_2_conv_relu_0[l][j]*enc_2_conv_relu_1_w[k*ENC_2_CONV_RELU_1_K*ENC_2_CONV_RELU_1_INPUT_FEATURES+(l-i+ENC_2_CONV_RELU_1_K/2)*ENC_2_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      enc_2_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_3_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_3_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += enc_2_maxpool[l][j]*enc_3_conv_relu_0_w[k*ENC_3_CONV_RELU_0_K*ENC_3_CONV_RELU_0_INPUT_FEATURES+(l-i+ENC_3_CONV_RELU_0_K/2)*ENC_3_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      enc_3_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<ENC_3_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<ENC_3_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += enc_3_conv_relu_0[l][j]*enc_3_conv_relu_1_w[k*ENC_3_CONV_RELU_1_K*ENC_3_CONV_RELU_1_INPUT_FEATURES+(l-i+ENC_3_CONV_RELU_1_K/2)*ENC_3_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      enc_3_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<CENTRAL_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<CENTRAL_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += enc_3_maxpool[l][j]*central_conv_relu_0_w[k*CENTRAL_CONV_RELU_0_K*CENTRAL_CONV_RELU_0_INPUT_FEATURES+(l-i+CENTRAL_CONV_RELU_0_K/2)*CENTRAL_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }
      central_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<CENTRAL_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<CENTRAL_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += central_conv_relu_0[l][j]*central_conv_relu_1_w[k*CENTRAL_CONV_RELU_1_K*CENTRAL_CONV_RELU_1_INPUT_FEATURES+(l-i+CENTRAL_CONV_RELU_1_K/2)*CENTRAL_CONV_RELU_1_INPUT_FEATURES+j]; 
        }
      }

      central_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
  //----------------------------------------------------------------------------
    ...
    for(int i=0; i<DEC_0_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += dec_0_upsample[l][j]*dec_0_up_conv_relu_w[k*DEC_0_UP_CONV_RELU_K*DEC_0_UP_CONV_RELU_INPUT_FEATURES+(l-i+DEC_0_UP_CONV_RELU_K/2)*DEC_0_UP_CONV_RELU_INPUT_FEATURES+j];
        }
      }
      dec_0_up_conv_relu[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_0_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += dec_0_concatenate[l][j]*dec_0_conv_relu_0_w[k*DEC_0_CONV_RELU_0_K*DEC_0_CONV_RELU_0_INPUT_FEATURES+(l-i+DEC_0_CONV_RELU_0_K/2)*DEC_0_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }
      dec_0_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_0_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_0_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += dec_0_conv_relu_0[l][j]*dec_0_conv_relu_1_w[k*DEC_0_CONV_RELU_1_K*DEC_0_CONV_RELU_1_INPUT_FEATURES+(l-i+DEC_0_CONV_RELU_1_K/2)*DEC_0_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      dec_0_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
  //----------------------------------------------------------------------------
    ...
    for(int i=0; i<DEC_1_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += dec_1_upsample[l][j]*dec_1_up_conv_relu_w[k*DEC_1_UP_CONV_RELU_K*DEC_1_UP_CONV_RELU_INPUT_FEATURES+(l-i+DEC_1_UP_CONV_RELU_K/2)*DEC_1_UP_CONV_RELU_INPUT_FEATURES+j];
        }
      }

      dec_1_up_conv_relu[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_1_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += dec_1_concatenate[l][j]*dec_1_conv_relu_0_w[k*DEC_1_CONV_RELU_0_K*DEC_1_CONV_RELU_0_INPUT_FEATURES+(l-i+DEC_1_CONV_RELU_0_K/2)*DEC_1_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      dec_1_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_1_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_1_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += dec_1_conv_relu_0[l][j]*dec_1_conv_relu_1_w[k*DEC_1_CONV_RELU_1_K*DEC_1_CONV_RELU_1_INPUT_FEATURES+(l-i+DEC_1_CONV_RELU_1_K/2)*DEC_1_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      dec_1_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
  //----------------------------------------------------------------------------
    ...
    for(int i=0; i<DEC_2_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += dec_2_upsample[l][j]*dec_2_up_conv_relu_w[k*DEC_2_UP_CONV_RELU_K*DEC_2_UP_CONV_RELU_INPUT_FEATURES+(l-i+DEC_2_UP_CONV_RELU_K/2)*DEC_2_UP_CONV_RELU_INPUT_FEATURES+j];
        }
      }

      dec_2_up_conv_relu[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_2_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += dec_2_concatenate[l][j]*dec_2_conv_relu_0_w[k*DEC_2_CONV_RELU_0_K*DEC_2_CONV_RELU_0_INPUT_FEATURES+(l-i+DEC_2_CONV_RELU_0_K/2)*DEC_2_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      dec_2_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_2_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_2_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += dec_2_conv_relu_0[l][j]*dec_2_conv_relu_1_w[k*DEC_2_CONV_RELU_1_K*DEC_2_CONV_RELU_1_INPUT_FEATURES+(l-i+DEC_2_CONV_RELU_1_K/2)*DEC_2_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      dec_2_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
  //----------------------------------------------------------------------------
    ...
    for(int i=0; i<DEC_3_UP_CONV_RELU_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_UP_CONV_RELU_INPUT_FEATURES; j++){
          acc += dec_3_upsample[l][j]*dec_3_up_conv_relu_w[k*DEC_3_UP_CONV_RELU_K*DEC_3_UP_CONV_RELU_INPUT_FEATURES+(l-i+DEC_3_UP_CONV_RELU_K/2)*DEC_3_UP_CONV_RELU_INPUT_FEATURES+j];
        }
      }

      dec_3_up_conv_relu[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_3_CONV_RELU_0_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_CONV_RELU_0_INPUT_FEATURES; j++){
          acc += dec_3_concatenate[l][j]*dec_3_conv_relu_0_w[k*DEC_3_CONV_RELU_0_K*DEC_3_CONV_RELU_0_INPUT_FEATURES+(l-i+DEC_3_CONV_RELU_0_K/2)*DEC_3_CONV_RELU_0_INPUT_FEATURES+j];
        }
      }

      dec_3_conv_relu_0[i][k] = ReLU(acc);
    }  
  }
    ...
    for(int i=0; i<DEC_3_CONV_RELU_1_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<DEC_3_CONV_RELU_1_INPUT_FEATURES; j++){
          acc += dec_3_conv_relu_0[l][j]*dec_3_conv_relu_1_w[k*DEC_3_CONV_RELU_1_K*DEC_3_CONV_RELU_1_INPUT_FEATURES+(l-i+DEC_3_CONV_RELU_1_K/2)*DEC_3_CONV_RELU_1_INPUT_FEATURES+j];
        }
      }

      dec_3_conv_relu_1[i][k] = ReLU(acc);
    }  
  }
  //----------------------------------------------------------------------------
    ...
    for(int i=0; i<FINAL_CONV_N; i++){
      ...
      for(int l=l_min; l<l_max; l++){
        for(int j=0; j<FINAL_CONV_INPUT_FEATURES; j++){
          acc += dec_3_conv_relu_1[l][j]*final_conv_w[k*FINAL_CONV_K*FINAL_CONV_INPUT_FEATURES+(l-i+FINAL_CONV_K/2)*FINAL_CONV_INPUT_FEATURES+j];
        }
      }
  ...
  for(int i=0; i<FINAL_CONV_N; i++){  // Iterate over the input matrix
    ...
    //Argmax_2(final_conv[i], y+i); //y declared as y[64]
  }
  //-----------------------------------------------------------------------------------
}