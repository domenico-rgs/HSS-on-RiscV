...
void Segmenter(float x[N][N_FEATURES],
  ...
  float enc_0_conv_relu_0[ENC_0_CONV_RELU_0_N][ENC_0_CONV_RELU_0_OUTPUT_FEATURES];
  float enc_0_conv_relu_1[ENC_0_CONV_RELU_1_N][ENC_0_CONV_RELU_1_OUTPUT_FEATURES];
  float enc_0_maxpool[ENC_0_CONV_RELU_1_N/2][ENC_0_CONV_RELU_1_OUTPUT_FEATURES];

  float enc_1_conv_relu_0[ENC_1_CONV_RELU_0_N][ENC_1_CONV_RELU_0_OUTPUT_FEATURES];
  float enc_1_conv_relu_1[ENC_1_CONV_RELU_1_N][ENC_1_CONV_RELU_1_OUTPUT_FEATURES];
  float enc_1_maxpool[ENC_1_CONV_RELU_1_N/2][ENC_1_CONV_RELU_1_OUTPUT_FEATURES];

  float enc_2_conv_relu_0[ENC_2_CONV_RELU_0_N][ENC_2_CONV_RELU_0_OUTPUT_FEATURES];
  float enc_2_conv_relu_1[ENC_2_CONV_RELU_1_N][ENC_2_CONV_RELU_1_OUTPUT_FEATURES];
  float enc_2_maxpool[ENC_2_CONV_RELU_1_N/2][ENC_2_CONV_RELU_1_OUTPUT_FEATURES];

  float enc_3_conv_relu_0[ENC_3_CONV_RELU_0_N][ENC_3_CONV_RELU_0_OUTPUT_FEATURES];
  float enc_3_conv_relu_1[ENC_3_CONV_RELU_1_N][ENC_3_CONV_RELU_1_OUTPUT_FEATURES];
  float enc_3_maxpool[ENC_3_CONV_RELU_1_N/2][ENC_3_CONV_RELU_1_OUTPUT_FEATURES];

  float central_conv_relu_0[CENTRAL_CONV_RELU_0_N][CENTRAL_CONV_RELU_0_OUTPUT_FEATURES];
  float central_conv_relu_1[CENTRAL_CONV_RELU_1_N][CENTRAL_CONV_RELU_1_OUTPUT_FEATURES];

  float dec_0_upsample[DEC_0_UP_CONV_RELU_N][DEC_0_UP_CONV_RELU_INPUT_FEATURES];
  float dec_0_up_conv_relu[DEC_0_UP_CONV_RELU_N][DEC_0_UP_CONV_RELU_OUTPUT_FEATURES];
  float dec_0_concatenate[DEC_0_UP_CONV_RELU_N][DEC_0_UP_CONV_RELU_OUTPUT_FEATURES*2];
  float dec_0_conv_relu_0[DEC_0_CONV_RELU_0_N][DEC_0_CONV_RELU_0_OUTPUT_FEATURES];
  float dec_0_conv_relu_1[DEC_0_CONV_RELU_1_N][DEC_0_CONV_RELU_1_OUTPUT_FEATURES];

  float dec_1_upsample[DEC_1_UP_CONV_RELU_N][DEC_1_UP_CONV_RELU_INPUT_FEATURES];
  float dec_1_up_conv_relu[DEC_1_UP_CONV_RELU_N][DEC_1_UP_CONV_RELU_OUTPUT_FEATURES];
  float dec_1_concatenate[DEC_1_UP_CONV_RELU_N][DEC_1_UP_CONV_RELU_OUTPUT_FEATURES*2];
  float dec_1_conv_relu_0[DEC_1_CONV_RELU_0_N][DEC_1_CONV_RELU_0_OUTPUT_FEATURES];
  float dec_1_conv_relu_1[DEC_1_CONV_RELU_1_N][DEC_1_CONV_RELU_1_OUTPUT_FEATURES];

  float dec_2_upsample[DEC_2_UP_CONV_RELU_N][DEC_2_UP_CONV_RELU_INPUT_FEATURES];
  float dec_2_up_conv_relu[DEC_2_UP_CONV_RELU_N][DEC_2_UP_CONV_RELU_OUTPUT_FEATURES];
  float dec_2_concatenate[DEC_2_UP_CONV_RELU_N][DEC_2_UP_CONV_RELU_OUTPUT_FEATURES*2];
  float dec_2_conv_relu_0[DEC_2_CONV_RELU_0_N][DEC_2_CONV_RELU_0_OUTPUT_FEATURES];
  float dec_2_conv_relu_1[DEC_2_CONV_RELU_1_N][DEC_2_CONV_RELU_1_OUTPUT_FEATURES];

  float dec_3_upsample[DEC_3_UP_CONV_RELU_N][DEC_3_UP_CONV_RELU_INPUT_FEATURES];
  float dec_3_up_conv_relu[DEC_3_UP_CONV_RELU_N][DEC_3_UP_CONV_RELU_OUTPUT_FEATURES];
  float dec_3_concatenate[DEC_3_UP_CONV_RELU_N][DEC_3_UP_CONV_RELU_OUTPUT_FEATURES*2];
