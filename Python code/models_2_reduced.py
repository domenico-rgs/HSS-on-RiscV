...
def get_model(N: int = 64, n_features: int = 4, num_classes: int = 4) -> Model:
    """Returns the model described in [1].

    Args:
    -----
        N (int): Number of samples in the input tensor. Default: 64.
        n_features (int): Number of features in the input tensor. Default: 4.
        num_classes (int): Number of classes in the output tensor. Default: 4.
    ...
    """
    # Input tensor
    input = Input(shape=(N, n_features)) 
