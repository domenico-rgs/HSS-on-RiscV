...
int main(){
  ...
  time = clock()-time;
	printf("\nTime required for memory and parameters initialization: %.5f seconds\n", ((double)time) / CLOCKS_PER_SEC);
  ...
  for(int i=0; i<1;i++){ //TEST_SAMPLES_BATCH
    ...
    //-----------------------------DECODER 0--------------------------------------
    upsampling<<<dimGrid_dec_0_up, dimBlock>>>(DEC_0_UP_CONV_RELU_INPUT_FEATURES, DEC_0_UP_CONV_RELU_N, d_dec_0_upsample, d_central_conv_relu_1);
    ...
    //-----------------------------DECODER 1--------------------------------------
    upsampling<<<dimGrid_dec_1_up, dimBlock>>>(DEC_1_UP_CONV_RELU_INPUT_FEATURES, DEC_1_UP_CONV_RELU_N, d_dec_1_upsample, d_dec_0_conv_relu_1);
    ...
    conv_relu<<<dimGrid_dec_11, dimBlock>>>(DEC_1_CONV_RELU_1_OUTPUT_FEATURES,DEC_1_CONV_RELU_1_N,DEC_1_CONV_RELU_1_K,DEC_1_CONV_RELU_1_INPUT_FEATURES,d_dec_1_conv_relu_1_w,d_dec_1_concatenate,d_dec_1_conv_relu_1);
    //----------------------------------------------------------------------------

    //-----------------------------DECODER 2--------------------------------------
    upsampling<<<dimGrid_dec_2_up, dimBlock>>>(DEC_2_UP_CONV_RELU_INPUT_FEATURES, DEC_2_UP_CONV_RELU_N, d_dec_2_upsample, d_dec_1_conv_relu_1);
    ...
    //-----------------------------DECODER 3--------------------------------------
    upsampling<<<dimGrid_dec_3_up, dimBlock>>>(DEC_3_UP_CONV_RELU_INPUT_FEATURES, DEC_3_UP_CONV_RELU_N, d_dec_3_upsample, d_dec_2_conv_relu_1);
